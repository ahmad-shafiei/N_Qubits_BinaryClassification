...
\PY{l+s+sd}{This script implements a custom ZZ feature\PYZhy{}map inspired kernel for SVM.}
\PY{l+s+sd}{It loads the user\PYZsq{}s dataset (complex readouts of 4 qubits), converts them}
\PY{l+s+sd}{to 8 real\PYZhy{}valued IQ features, defines a tunable ZZ kernel, and trains an SVM}
\PY{l+s+sd}{to classify one qubit\PYZsq{}s state (0/1). The gamma parameters of the kernel }
\PY{l+s+sd}{can be easily modified for experimentation.}

\PY{l+s+sd}{Dataset format:}
\PY{l+s+sd}{    X: 16000 × 4   (complex values)      \PYZlt{}\PYZhy{}\PYZhy{} loaded as dtype=complex}
\PY{l+s+sd}{    y: 16000 × 4   (bit labels)}
\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
\PY{c+c1}{\PYZsh{} ================================================================}
\PY{c+c1}{\PYZsh{} 1) Load the dataset (fully compatible with your stored files)}
\PY{c+c1}{\PYZsh{} ================================================================}
...
\PY{c+c1}{\PYZsh{} ================================================================}
\PY{c+c1}{\PYZsh{} 2) Convert complex data → 8 real features}
\PY{c+c1}{\PYZsh{} ================================================================}
...
\PY{c+c1}{\PYZsh{} ================================================================}
\PY{c+c1}{\PYZsh{} 3) Build the ZZ kernel (fully tunable)}
\PY{c+c1}{\PYZsh{} ================================================================}
...
\PY{c+c1}{\PYZsh{} ================================================================}
\PY{c+c1}{\PYZsh{} 4) Train SVM for a selected qubit index using ZZ kernel}
\PY{c+c1}{\PYZsh{} ================================================================}
...
\PY{k}{if} \PY{n+nv+vm}{\PYZus{}\PYZus{}name\PYZus{}\PYZus{}} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZus{}\PYZus{}main\PYZus{}\PYZus{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
    \PY{n}{model}\PY{p}{,} \PY{n}{acc}\PY{p}{,} \PY{n}{cm} \PY{o}{=} \PY{n}{train\PYZus{}svm\PYZus{}with\PYZus{}zz\PYZus{}kernel}\PY{p}{(}
        ...
        \PY{n}{gamma\PYZus{}pair}\PY{o}{=}\PY{l+m+mf}{0.3}
    \PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Training SVM for qubit 1 using ZZ kernel{\ldots}
Accuracy = 0.6995
Confusion matrix:
 [[1557  443]
 [ 759 1241]]
